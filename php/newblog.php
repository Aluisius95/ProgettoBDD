  ...
  <body onload="users(); the(); sty()">
    <nav>
      <ul class="navbar comportamento">
        ...
        <li id="pr">
          <a href="profile.php" id="profilebtn">Profilo</a>
        </li>
        <li id="lo">
    ...
    <div class="grid-container">
      <div id="newblog" class="grid-item sx">
      <form class="nb" method="post">
        <input type="text" name="TitB" id="TitB" maxlength="30" width="35" placeholder="Titolo del blog"><br>
        <label for="theme">Genere del blog:
          <select class="theme" name="theme" id="theme">
          
          </select>
        </label><br>
        <label for="style">Stile del blog:
          <select class="style" name="style" id="style">

          </select>
        </label><br>
        <button type="button" id="recB" name="recB" onclick="registerB()">Crea nuovo blog</button>
      </form>
      <div id="errNB"></div>
      </div>
